...
LIVES_INTERVAL = (25 * 60, 35 * 60)  # 25-35 minutes
SEND_LIFE_CONFIRM_TIMEOUT = 5.0
SEND_LIFE_SENT_TIMEOUT = 8.0
SEND_LIFE_TOP_MAX_SCROLLS = 20
SEND_LIFE_NO_BUTTON_MAX_SCROLLS = 10
SEND_LIFE_MAX_TRANSITION_FAILURES = 3
SEND_LIFE_STABLE_CHECK_INTERVAL = 0.2
SEND_LIFE_STABLE_MAX_CHECKS = 5
SEND_LIFE_STABLE_DIFF_THRESHOLD = 3.0
UNKNOWN_STAGE_RESET_TIMEOUT = {
    "PRE_GAME": 60.0,
    "IN_GAME": 600.0,
    "POST_GAME": 60.0,
}
MAX_UNKNOWN_STAGE_RESTARTS = 3  # give up (stop bot) after this many consecutive stage-unknown restarts
MAX_FAILED_TO_RETRIEVE_DATA_RETRIES = 3  # after this many Confirm taps, force a full app restart instead

# -------------------
# ALERTS (Telegram)
# -------------------
# Create a bot via @BotFather to get a token, and message it once so you can
# find your chat_id (e.g. via https://api.telegram.org/bot<token>/getUpdates).
...
STAGE_FAILED_TO_RETRIEVE_DATA_TEMPLATE = ["FAILED_TO_RETRIEVE_DATA_1.png"]
STAGE_INACTIVE_TEMPLATE = ["INACTIVE_1.png"]
STAGE_PREVIOUS_RANK_RESULTS_TEMPLATE = ["PREVIOUS_RANK_RESULTS_1.png"]
STAGE_PREVIOUS_RESULTS_CONFIRM_TEMPLATE = ["PREVIOUS_RESULTS_CONFIRM_1.png"]
...
STAGE_FAILED_TO_RETRIEVE_DATA_REGION = (400, 268, 880, 305)
STAGE_INACTIVE_REGION = (358, 247, 934, 372)
STAGE_PREVIOUS_RANK_RESULTS_REGION = (454, 42, 832, 115)
STAGE_PREVIOUS_RESULTS_CONFIRM_REGION = (480, 218, 800, 280)
...
FRIEND_COOKIE_DIALOG_TEMPLATE = ["FRIEND_COOKIE_DIALOG_1.png"]
FRIEND_INFO_DIALOG_TEMPLATE = ["FRIEND_INFO_DIALOG_1.png"]
SEND_LIFE_CONFIRM_DIALOG_TEMPLATE = ["SEND_LIFE_CONFIRM_DIALOG_1.png"]
SEND_LIFE_SENT_DIALOG_TEMPLATE = ["SEND_LIFE_SENT_DIALOG_1.png"]
...
FRIEND_COOKIE_DIALOG_REGION = (430, 0, 850, 120)
FRIEND_INFO_DIALOG_REGION = (450, 10, 850, 130)
SEND_LIFE_CONFIRM_DIALOG_REGION = (450, 240, 900, 380)
SEND_LIFE_SENT_DIALOG_REGION = (450, 220, 830, 340)
...
STAGE_TEMPLATES = {
    ...
    "FAILED_TO_RETRIEVE_DATA": STAGE_FAILED_TO_RETRIEVE_DATA_TEMPLATE,
    ...
    "PREVIOUS_RESULTS_CONFIRM": STAGE_PREVIOUS_RESULTS_CONFIRM_TEMPLATE,
}
...
STAGE_REGIONS = {
    ...
    "FAILED_TO_RETRIEVE_DATA": STAGE_FAILED_TO_RETRIEVE_DATA_REGION,
    "INACTIVE":                STAGE_INACTIVE_REGION,
    "PREVIOUS_RANK_RESULTS":   STAGE_PREVIOUS_RANK_RESULTS_REGION,
    "PREVIOUS_RESULTS_CONFIRM": STAGE_PREVIOUS_RESULTS_CONFIRM_REGION,
...
CONFIRM_PREVIOUS_RESULTS_BUTTON = (635, 453)
...
FAILED_TO_RETRIEVE_DATA_CONFIRM_BUTTON = (640, 458)
...
CANCEL_SEND_LIFE_BUTTON = (485, 460)
CLOSE_SEND_LIFE_DIALOG_BUTTON = (645, 463)
FRIEND_COOKIE_DIALOG_CLOSE_BUTTON = (1037, 83)
FRIEND_INFO_DIALOG_CLOSE_BUTTON = (1091, 70)
